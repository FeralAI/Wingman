...
namespace NETStandardLibrary.Tests.Data
{
	public class Person
	{
		public static IQueryable<Person> Data
		{
			get => new List<Person> {
				...
				new Person { FirstName = "Bob", LastName = "Smith", Age = 20, Mother = Mom },
				new Person { FirstName = "Jackie", LastName = "Johnson", Age = 25, Father = Dad },
				new Person { FirstName = "Keith", LastName = "Myers", Age = 28 },
				new Person { FirstName = "Bob", LastName = "Johnson", Age = 22, Father = Dad },
			}.AsQueryable();
		}

		private static Person Mom = new Person { FirstName = "Mary", LastName = "Henderson", Age = 51 };
